...
urlpatterns = [
    ...
    path('<slug:category_slug>/<int:question_id>/results/', views.ResultPollView.as_view(), name='results'),
    path('<slug:category_slug>/<int:question_id>/vote/', views.PollVoteView.as_view(), name='vote'),
]
